...
function pumpGetRoute(routeParamsOrGetRoute?: any, maybeGetRoute?: any) {
  ...
  const pumpedRoute = (routeParams?: PumpedGetRouteInputBase) => {
  ...
  pumpedRoute.placeholders = placeholders;
  pumpedRoute.definition = definition;
  pumpedRoute.useParams = useReactRouterParams as any;
  return pumpedRoute;
}
